...
public class Icons {
	...
	public static class M extends IconMaker{
		...
		public final Icon entertainment = get();
		public final Icon water = get();
		public final Icon sword = get();
		public final Icon fish = get();
		public final Icon pasture = get();
